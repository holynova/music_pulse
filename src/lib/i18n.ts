...
const COPY: Record<Language, Copy> = {
  en: {
    ...
    findingPulse: 'Finding the pulse',
    ...
    pulseNote: 'Pulse maps are generated from energy changes in the audio. The stronger the moment, the more the path turns.',
  ...
  zh: {
    ...
    pulseNote: '脉冲轨迹来自音频中的能量变化。变化越强，路径转弯越明显。',
